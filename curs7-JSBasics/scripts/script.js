...
var price = 4.99 // not "4.99$" <- this is a string, not number
console.log("The price is", price, "$");

var fullName = "Alexandru Merca"
...
var differentQuotes ='"another string \'side quotes"'
...
console.log(2 === '2'); //false -> === verifica atat valoarea 
console.log(2 ===2); // true
...
var names = ['alexandru', 'razvan', 'serban', 'marcus', 'diana', 'tamas', 'norbert'];
console.log(names[2]);
...
var robot = {
  model: 'TRX1000',
  color: 'red',
  "full name": "Robots name",
  //color: 'blue', <- having duplicate keys in the same object is not correct
  walk: function() {
...
console.log('full name', robot["full name"]); //robot.fullname is incorrect
robot.walk();
...
var email = "melania.moldovan@scoalainformala.com";
